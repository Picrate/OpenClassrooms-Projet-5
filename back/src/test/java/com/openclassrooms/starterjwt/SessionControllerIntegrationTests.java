...
@DisplayName("Check API operations on Sessions")
...
public class SessionControllerIntegrationTests {
    ...
    @Test
    void shouldReturn_NotFound_If_ParticipateToANonExistingSession(){

        // Subscribe User 2 To Session 1
        HttpEntity<String> httpEntity = new HttpEntity<>("", headers);
        ResponseEntity<String> response = testRestTemplate.exchange("/api/session/99/participate/2", HttpMethod.POST, httpEntity, String.class);
    ...
    @Test
    void shouldReturn_NotFound_If_ParticipateWithANonExistingUser(){

        // Subscribe User 2 To Session 1
        HttpEntity<String> httpEntity = new HttpEntity<>("", headers);
        ResponseEntity<String> response = testRestTemplate.exchange("/api/session/2/participate/99", HttpMethod.POST, httpEntity, String.class);
    ...
    @Test
    void shouldReturn_BadRequest_If_ParticipateToAnAlreadySubscribedSession(){

        // Subscribe User 2 To Session 1
        HttpEntity<String> httpEntity = new HttpEntity<>("", headers);
        ResponseEntity<String> response = testRestTemplate.exchange("/api/session/2/participate/2", HttpMethod.POST, httpEntity, String.class);
    ...
    @Test
    void shouldReturn_NotFound_If_UnParticipateToANonExistingSession(){

        // Subscribe User 2 To Session 1
        HttpEntity<String> httpEntity = new HttpEntity<>("", headers);
        ResponseEntity<String> response = testRestTemplate.exchange("/api/session/99/participate/2", HttpMethod.DELETE, httpEntity, String.class);
    ...
    @Test
    void shouldReturn_BadRequest_If_UnParticipateWithANonExistingUser(){

        // Subscribe User 2 To Session 1
        HttpEntity<String> httpEntity = new HttpEntity<>("", headers);
        ResponseEntity<String> response = testRestTemplate.exchange("/api/session/2/participate/99", HttpMethod.DELETE, httpEntity, String.class);
    ...
    @Test
    void shouldReturn_BadRequest_If_UnParticipateToANonSubscribedSession(){

        // Subscribe User 2 To Session 1
        HttpEntity<String> httpEntity = new HttpEntity<>("", headers);
        ResponseEntity<String> response = testRestTemplate.exchange("/api/session/1/participate/2", HttpMethod.DELETE, httpEntity, String.class);
